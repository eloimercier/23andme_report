...
short_names <- shortenCategoryNames(names(my_genotypes_medical_condition), max_char=15)
...
category_links <- file.path("file://",files_out_dir, "is_a_medical_condition",paste0(short_names, ".html"))
